                    ...
                    @forelse($documents as $doc)
                        <tr class="hover:bg-zinc-800/30 transition">
                            ...
                            <td class="py-4 px-4">
                                @php
                                    $statusColors = [
                                        'processed' => 'bg-green-500/10 text-green-700 border border-green-500/20',
                                        'uploaded' => 'bg-yellow-500/10 text-yellow-700 border border-yellow-500/20',
                                        'failed' => 'bg-red-500/10 text-red-600 border border-red-500/20',
                                    ];
                                    $color = $statusColors[$doc->status] ?? 'bg-zinc-500/10 text-zinc-700';
                                @endphp
